...
function buildShareOptions(url: string, title: string): ShareOption[] {
  ...
  return [
    ...
    },
    {
      id: "reddit",
      label: "Reddit",
      href: `https://reddit.com/submit?url=${encode(url)}&title=${encode(title)}`,
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    },
    {
      id: "bluesky",
      label: "Bluesky",
      href: `https://bsky.app/intent/compose?text=${encode(text)}`,
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
          <path d="M12 10.8c-1.087-2.114-4.046-6.053-6.798-7.995C2.566.944 1.561 1.266.902 1.565.139 1.913 0 3.583 0 4.745c0 1.093.637 8.933 1.053 10.215.346 1.057 1.818 1.407 3.099.86 1.777-.754 3.757-2.447 4.848-3.88 1.091 1.433 3.071 3.126 4.848 3.88 1.281.547 2.753.197 3.099-.86.416-1.282 1.053-9.122 1.053-10.215 0-1.162-.139-2.832-.902-3.18-.659-.299-1.664-.621-4.3 1.24C16.046 4.747 13.087 8.686 12 10.8z" />
        </svg>
      ),
    },
    {
...
export default function ShareBar({ url, title }: ShareBarProps) {
  ...
  return (
    <aside className={styles.shareBar} aria-label="Share article">
